export default function Home() {
    return (
        <div className={'flex flex-col'}>
            <div className={'bg-primary-3 p-1 m-1 rounded-md text-blank text-xl'}>
                <h2>Katra Sterner</h2>
            </div>
            <div className={'flex flex-col gap-3'}>
                <h3 className={'text-primary-2 text-2xl font-bold'}>First</h3>
                <p className={'text-primary-1 p-4 bg-primary-3 rounded-xl'}>
                    Lorem Ipsum
                ...
                <h3 className={'text-primary-2 text-2xl font-bold'}>Second</h3>
                <p className={'text-primary-1 p-4 bg-primary-3 rounded-xl'}>
                    ...
                    The standard chunk of Lorem Ipsum used since 1966 is reproduced below for
                ...
                <p className={'text-primary-1 p-4 bg-primary-3 rounded-xl'}>
                    ...
                    Donate: If you use this site regularly and would like to help keep the site on
                    the Internet, please consider donating a small sum to help pay for the hosting
                    and bandwidth bill. There is no minimum donation, any sum is appreciated - click
                    here to donate using PayPal. Thank you for your support. Donate bitcoin:
                    16UQLq1HZ3CNwhvgrarV6pMoA2CDjb4tyF
                    Translations: Can you help translate this site into a foreign language ? Please
                    email us with details if you can help.
                    There is a set of mock banners available here in three colours and in a range
                    of standard banner sizes:
                    BannersBannersBanners
                    NodeJS Python Interface GTK Lipsum Rails .NET
                </p>
                <h3 className={'text-primary-2 text-2xl font-bold'}>Fourth</h3>
                <p className={'text-primary-1 p-4 bg-primary-3 rounded-xl'}>
                    freestar
                ...
                <h3 className={'text-primary-2 text-2xl font-bold'}>Seventh</h3>
                <p className={'text-primary-1 p-4 bg-primary-3 rounded-xl'}>
                    ...
                    choice is untrammelled and when nothing prevents our being able to do what we lik
                    e best, every pleasure is to be welcomed and every pain avoided. But in certain
